    ...
    class Utility
    {
            ...
            try
            {
                if (number > 0 && number < 31)
                {
                    for (int i = 1; i <= number; i++)
                    {
                        ...
                        Console.WriteLine("2 to power " + i + " : " + power);
                    }
                }
                else
                {   
        ...
        public static void GuessNumberWorking(int lower, int upper)
        {
            ...
            while (low <= high)
            {
                ...
                int answer = Utility.IntegerInput();
                if (answer == 1)
                {
        ...
        /* ============================LOGICAL PROGRAM=============================== */
        /*-------------------------------Gambler-------------------------------- */
        public static void Gambblr(int stakes, int goal, int number)
        {
            ...
            Console.WriteLine(win + " win of {0} ", number);
            Console.WriteLine( "percentage of wins : " +(100.0 * win) /number );
            Console.WriteLine("bets : {0} ",  bet );
        }
